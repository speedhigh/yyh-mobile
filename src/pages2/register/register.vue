	...
	<view class="changeCard">
		<view class="wrap">
			<form @submit="formSubmit" @reset="formReset">
				...
				<view class="inputBox">
					<image class="icon" :src="iconUser" mode=""></image>
					<input class="input" maxlength="14" name="card" v-model="InputCard" placeholder="请输入您的权益卡号(可不填)" />
					<image class="get" @click="scanCode()" src="https://yuyihui-re.oss-cn-beijing.aliyuncs.com/f28ff3cd-dbad-43c1-a683-e7c3a58d1722.png">
					</image>
				</view>
				<view class="inputBox">
					<image class="icon" :src="iconPass" mode=""></image>
					<input class="input" maxlength="11" password="true" v-model="InputPass" name="密码" placeholder="请输入您的权益卡密码(可不填)" />
				</view>
				<view class="logBox">
